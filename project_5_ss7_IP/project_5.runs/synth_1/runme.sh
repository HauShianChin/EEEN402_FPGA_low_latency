...
HD_PWD='H:/EEEN402/project_5/project_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log one_second_clock_behaviour.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source one_second_clock_behaviour.tcl
