...
HD_PWD='H:/EEEN402/week2projects/project_2_3/project_2_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log muxdelay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source muxdelay.tcl -notrace
