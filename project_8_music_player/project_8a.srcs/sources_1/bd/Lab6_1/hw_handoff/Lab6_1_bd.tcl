...
################################################################
# This is a generated script based on design: Lab6_1
#
...
proc create_root_design { parentCell } {
  ...
  set PWMAudio_0 [ create_bd_cell -type ip -vlnv BIGTGAMING:user:PWMAudio:1.0 PWMAudio_0 ]
  ...
  # Create port connections
  connect_bd_net -net PWMAudio_0_AUD_PWM [get_bd_ports AUD_PWM] [get_bd_pins PWMAudio_0/AUD_PWM]
  connect_bd_net -net PWMAudio_0_AUD_SD [get_bd_ports AUD_SD] [get_bd_pins PWMAudio_0/AUD_SD]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins PWMAudio_0/SW] [get_bd_pins axi_gpio_1/gpio_io_o]
