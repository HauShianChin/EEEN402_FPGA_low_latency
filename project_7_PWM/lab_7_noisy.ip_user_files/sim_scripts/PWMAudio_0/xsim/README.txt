...
#
# Generated by export_simulation on Mon Sep 12 15:19:13 +1200 2022
#
################################################################################
...
'-reset_run' switch to the './PWMAudio_0.sh' script.

./PWMAudio_0.sh -reset_run
...
./PWMAudio_0.sh -noclean_files

For more information on the script, please type './PWMAudio_0.sh -help'.
