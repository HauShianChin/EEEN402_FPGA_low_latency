...
HD_PWD='H:/EEEN402/lab 7/lab_7_noisy/lab_7_noisy.runs/PWMAudio_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWMAudio_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PWMAudio_0.tcl
