...
proc create_root_design { parentCell } {
  ...
  set SW_0 [ create_bd_port -dir I -from 8 -to 0 SW_0 ]
  ...
  set PWMAudio_0 [ create_bd_cell -type ip -vlnv Delta_securities:user:PWMAudio:1.0 PWMAudio_0 ]
  ...
  connect_bd_net -net SW_0_1 [get_bd_ports SW_0] [get_bd_pins PWMAudio_0/SW]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins PWMAudio_0/CLK100MHZ] [get_bd_pins clk_wiz_0/clk_out1]
