...
HD_PWD='H:/EEEN402/week2projects/project_2_3/project_2_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log muxdelay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source muxdelay.tcl
